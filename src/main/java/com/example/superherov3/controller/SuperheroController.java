...
public class SuperheroController {
    ...
    public ResponseEntity<Superhero> deleteSuperhero(@PathVariable String superheroName){
        Superhero returnDeletedSuperhero = superheroService.deleteSuperhero(superheroName);
